...
public class HcqlDemo2 {
	...
	public static void main(String[] args) 
	{
	 ...
	 //write a criteria to fetch first 3 records from dtabase table
	 ...
	 //Write a criteria to exclide first 3 records from database table 
	 ...
	 //Write a criteria to display all the student details having percentage greater than 65
    ...
    //	 Write a creteria to display all the student details having percentage between 60 and 80
	 ...
	 // Write a criteria to display all the deatails of student from cumputer stream 
	 
	 Criteria crt5= ses.createCriteria(Student.class);
	 
	 crt5.add(Restrictions.like("studentStream", "COMP"));
	 ...
	 System.out.println("*********************************************************************************************");
	 // Write a croteria to display all the details of  studentd  whose name end with H. Display only computer stream student

     Criteria crt6= ses.createCriteria(Student.class);
	 
	 crt6.add(Restrictions.like("studentName", "%H"));
	 crt6.add(Restrictions.like("studentStream", "COMP"));
	 ...
	 System.out.println("***********************************************************************************************************");
	 // Write a criteria to display in decending order acording to there percentage 
